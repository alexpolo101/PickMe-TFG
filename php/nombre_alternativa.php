...
if(isset($_POST['nombrealt-submit'])) {
  ...
  if (empty($nuevonombre) || empty($idalt) ){
    ...
    if (!mysqli_stmt_prepare($stmt, $sql)) {
      ...
      mysqli_stmt_bind_param($stmt, "si", $nuevonombre,$idalt);
      mysqli_stmt_execute($stmt);
      $result = mysqli_stmt_get_result($stmt);

      header("Location: ../modificar_alternativa.php?updatename=success&idalt=$idalt&namealt=$nuevonombre&nombrepick=$nombre");
      exit();
    }
  }
}
